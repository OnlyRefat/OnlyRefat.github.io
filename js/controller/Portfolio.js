app.controller('portfolioCtrl',function($scope){
	...
	{name:'Latify',details:"An Google Map Reactjs Implementation for finding latitude, longitude. Open Source", image:['image/RP/2.png'],link:'https://onlyrefat.github.io/latify/'},
